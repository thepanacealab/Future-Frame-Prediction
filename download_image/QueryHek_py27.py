...
def helioviewer():
    ...
    try:
        ...
        # print(x5)
        # print(y5)
        inputCsvDataFile = raw_input("Enter input csv data file directory path with csv data file name: ")
        ...
        directoryJp2 = raw_input("Enter Jp2 image output directory path: ")
        directoryJpg = raw_input("Enter Jpeg image output directory path: ")
        directoryJpgCrop = raw_input("Enter cropped Jpeg image with bbox output directory path: ")
        #directoryJpgPoly = raw_input("Enter Jpeg image with polygon output directory path: ")
        counter = 0
        for event_startTimeData in event_startTime:
            ...
            while start <= end:
                ...
                #img = PILImage.open(directoryJp2TrackID + resImageUriData + ".jp2")
                #img.save(directoryJpgTrackID + resImageUriData + ".png")                
